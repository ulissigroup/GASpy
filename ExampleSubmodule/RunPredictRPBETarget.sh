...
PYTHONPATH='.' luigi --module ExampleTargets StudyCoordinationSites  --xc=rpbe --scheduler-host gilgamesh.cheme.cmu.edu  --workers=16 --log-level=WARNING --parallel-scheduling --worker-timeout 300 
