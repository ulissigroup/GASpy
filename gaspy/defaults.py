...
GAS_SETTINGS = {'vasp': dict(ibrion=2,
                             nsw=100,
                             isif=0,
                             kpts=(1, 1, 1),
                             ediffg=-0.03,
...
SLAB_SETTINGS = {'max_miller': 2,
                 'vasp': dict(ibrion=2,
                              ...
                              pp_version=PP_VERSION,
                              **XC_SETTINGS[XC]),
                 'slab_generator_settings': dict(min_slab_size=7.,
                                                 min_vacuum_size=20.,
                                                 lll_reduce=False,
                                                 center_slab=True,
                                                 primitive=True,
                                                 max_normal_search=1),
                 'get_slab_settings': dict(tol=0.3,
                                           bonds=None,
                                           max_broken_bonds=0,
                                           symmetrize=False)}
